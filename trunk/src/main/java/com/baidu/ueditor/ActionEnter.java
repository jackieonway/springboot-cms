...
public class ActionEnter {
	...
	public ActionEnter(HttpServletRequest request, String rootPath,String fileRoot) {
	...
	public String invoke() {
		...
		case ActionMap.UPLOAD_FILE:
			...
			state = new Uploader(request, conf,fileRoot).doExec();
			break;
		...
		case ActionMap.LIST_FILE:
			...
			//文件的根目录
			conf.put("filePath",this.fileRoot);
