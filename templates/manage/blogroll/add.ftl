<#include "../include/head.ftl">
    <div class="page-wrap">
        ...
        <section class="page-hd">
            <header>
                <h2 class="title">新增友情链接配置</h2>
                <p class="title-description">
                    按照格式填写友情链接配置信息，添加完成后，点击保存按钮，保存成功后跳转友情链接信息列表
                </p>
            </header>
            <hr>
        </section>
                ...
                <div class="panel-bd">
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont txt-width">
                            <input type="text" name="blogrollName" placeholder="友情链接名" class="form-control form-boxed">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">友情链接地址：</div>
                        <div class="form-cont txt-width">
                            <input type="text"  name="blogrollUrl" placeholder="友情链接地址" class="form-control form-boxed">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">友情链接描述：</div>
                        <div class="form-cont txt-width">
                            <input type="text" name="description" placeholder="友情链接描述" class="form-control form-boxed">
                        </div>
                    </div>
                    </div>
                    <div class="form-group-col-2">
 ...
 <script type="text/javascript">
     $(function(){
         ...
         $(".submit").click(function () {
             ...
             $.ajax({
                 type: "POST",
                 url: "/adminManager/blogroll/addBlogroll",
                 data: formData,
                 async: false,
                 cache: false,
                 contentType: false,
