        ...
        <section class="page-hd">
            <header>
                ...
                <p class="title-description">
                    按照格式填写轮播图，添加完成后，点击保存按钮，保存成功后跳转轮播图列表
                </p>
            </header>
            <hr>
        </section>
                ...
                <div class="panel-bd">
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont txt-width">
                            <input type="text" name="name" placeholder="轮播图名称" class="form-control form-boxed">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                    ...
                    <div class="form-group-col-2">
                        ...
                        <div class="form-cont txt-width">
                            <input type="text" name="url" placeholder="链接" class="form-control form-boxed">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">ALT标题：</div>
                        <div class="form-cont txt-width">
                            <textarea id="summary" name="alt" class="form-control form-boxed" placeholder="ALT标题"></textarea>
                        </div>
                    </div>
                    <div class="form-group-col-2">
 ...
 <script type="text/javascript">
     $(function(){
         ...
         $(".submit").click(function () {
             ...
             $.ajax({
                 type: "POST",
                 url: "/adminManager/headline/addHeadline",
                 data: formData,
                 async: false,
                 cache: false,
                 contentType: false,
