        ...
        <ul>
            ...
            <li>
                <div class="form-group">
                    ...
                    <input type="email" placeholder="邮箱" class="form-control form-underlined" name="email"
                           id="email"/>
                </div>
            </li>
            <li>
            ...
            <li>
                <button class="btn btn-lg btn-block" id="forget">提交</button>
            </li>
            <li>
